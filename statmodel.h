...
public:
    ...
    void printRunIds(std::ostream& os);
    ...
    // vuong moved chivec from private to public
    Array1d<double> chivec;
//    Array1d<double> misfit_vec; // for debug
private:
    ...
    Array2d<double> AtA1, AtA2;
    Array1d<double> Atb1, Atb2;
    // chivec was here
